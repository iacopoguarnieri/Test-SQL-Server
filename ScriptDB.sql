...
/* Creo le tabelle */ 
CREATE TABLE ASSICURAZIONI(CodAss varchar ( 255 ) NOT NULL PRIMARY KEY, Nome varchar ( 255 ) NOT NULL, Sede varchar ( 255 ) NOT NULL) 
CREATE TABLE PROPRIETARI(CodF varchar ( 255 ) NOT NULL PRIMARY KEY, Nome varchar ( 255 ) NOT NULL, Residenza varchar ( 255 ) NOT NULL ) 
CREATE TABLE AUTO (Targa varchar ( 255 ) NOT NULL PRIMARY KEY, Marca varchar ( 255 ) NOT NULL, Cilindrata int NOT NULL, Potenza int NOT NULL, CodF varchar ( 255 ) NOT NULL, CodAss varchar ( 255 ) NOT NULL, FOREIGN KEY (CodF) REFERENCES PROPRIETARI(CodF), FOREIGN KEY (CodAss) REFERENCES ASSICURAZIONI(CodAss) ) 
CREATE TABLE SINISTRI( CodS varchar ( 255 ) NOT NULL PRIMARY KEY, Localita varchar ( 255 ) NOT NULL, Data date NOT NULL ) 
CREATE TABLE AUTOCOINVOLTE( CodS varchar ( 255 ) NOT NULL, Targa varchar ( 255 ) NOT NULL, ImportoDelDanno float NULL PRIMARY KEY (CodS,Targa) ) 
